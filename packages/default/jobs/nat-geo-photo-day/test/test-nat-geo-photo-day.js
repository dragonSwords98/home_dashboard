/**
 * Test file for Job: nat-geo-photo-day
 */

var assert = require ('assert');
var nat_geo_photo_day_SUT = require('../nat-geo-photo-day');

var mockedConfig, mockedDependencies;

describe ('nat-geo-photo-day test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      nat_geo_photo_day_SUT.onRun(config, mockedDependencies, function(err, data){
