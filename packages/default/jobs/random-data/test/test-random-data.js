/**
 * Test file for Job: random-data
 */

var assert = require ('assert');
var random_data_SUT = require('../random-data');

var mockedConfig, mockedDependencies;

describe ('random-data test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      random_data_SUT.onRun(config, mockedDependencies, function(err, data){
