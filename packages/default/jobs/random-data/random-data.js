...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/random-data file)
     ...
     Have a look at test/random-data for an example of how to unit tests this easily by mocking easyRequest calls

     */

    dependencies.easyRequest.HTML('http://www.google.com', function (err, html) {
      // logger.trace(html);
      jobCallback(err, {title: config.widgetTitle, html: ""});
    });
  }
};
