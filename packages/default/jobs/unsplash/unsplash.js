...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/unsplash file)
     ...
     Have a look at test/unsplash for an example of how to unit tests this easily by mocking easyRequest calls
    ...
    dependencies.easyRequest.JSON(options, function (err, json) {
      // logger.trace(json);
      // console.log(json);
      console.log(options);
      jobCallback(err, {title: config.widgetTitle, json: json});
    });
  }
};
