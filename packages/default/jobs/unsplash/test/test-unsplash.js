/**
 * Test file for Job: unsplash
 */

var assert = require ('assert');
var unsplash_SUT = require('../unsplash');

var mockedConfig, mockedDependencies;

describe ('unsplash test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      unsplash_SUT.onRun(config, mockedDependencies, function(err, data){
