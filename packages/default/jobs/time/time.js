...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    jobCallback(null, {title: config.WidgetTitle, time: new Date().toJSON()});
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/time file)
     ...
     Have a look at test/time for an example of how to unit tests this easily by mocking easyRequest calls
