/**
 * Test file for Job: speedtest-net
 */

var assert = require ('assert');
var speedtest_net_SUT = require('../speedtest-net');

var mockedConfig, mockedDependencies;

describe ('speedtest-net test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      speedtest_net_SUT.onRun(config, mockedDependencies, function(err, data){
