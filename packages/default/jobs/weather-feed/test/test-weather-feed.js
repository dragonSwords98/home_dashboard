/**
 * Test file for Job: weather-feed
 */

var assert = require ('assert');
var weather_feed_SUT = require('../weather-feed');

var mockedConfig, mockedDependencies;

describe ('weather-feed test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      weather_feed_SUT.onRun(config, mockedDependencies, function(err, data){
