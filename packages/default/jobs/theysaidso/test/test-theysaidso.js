/**
 * Test file for Job: theysaidso
 */

var assert = require ('assert');
var theysaidso_SUT = require('../theysaidso');

var mockedConfig, mockedDependencies;

describe ('theysaidso test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      theysaidso_SUT.onRun(config, mockedDependencies, function(err, data){
